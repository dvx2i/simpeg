 ...
 * @author Zanuar
 */
class CpnsPendidikanUmum extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_cpns_pendidikan($data['tahun'], $data['bulan']);
        $this->loadView('rekap/rekap_cpns_pendidikan', $data);
    }
