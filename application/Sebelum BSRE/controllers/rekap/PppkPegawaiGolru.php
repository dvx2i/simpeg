 ...
 * @author Zanuar
 */
class PppkPegawaiGolru extends MY_Controller
{
    ...
    function index()
    {
        ...
        $data['bulan2']  = '';
        $data['golru']  = '';
        $data = $this->m_pegawai_rekap_golru->data_pppk($data['tahun'], $data['bulan'], $data['unit'], $data['jenis'], $data['periode'], $data['tahun2'], $data['bulan2'], $data['golru']);
        $this->loadView('rekap/pppk_pegawai_golru', $data);
    }
