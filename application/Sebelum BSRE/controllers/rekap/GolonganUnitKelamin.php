 ...
 * @author Zanuar
 */
class GolonganUnitKelamin extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_unit_golongan_eselon_jenis_kelamin($data['tahun'], $data['bulan'],2);
        $this->loadView('rekap/rekap_golongan_unit_kelamin', $data);
    }
