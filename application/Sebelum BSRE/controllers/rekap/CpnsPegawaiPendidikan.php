 ...
 * @author Zanuar
 */
class CpnsPegawaiPendidikan extends MY_Controller
{
    ...
    function index()
    {
        ...
        $data['bulan2']  = '';
        $data['pendidikan']  = '';
        $data = $this->m_pegawai_rekap_pendidikan->data_cpns($data['tahun'], $data['bulan'], $data['unit'], $data['jenis'], $data['periode'], $data['tahun2'], $data['bulan2'], $data['pendidikan']);
        $this->loadView('rekap/cpns_pegawai_pendidikan', $data);
    }
