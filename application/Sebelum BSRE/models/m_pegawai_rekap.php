...
SELECT 	 
    ...
    function update_rekap_agama($tahun,$bulan) {
        $query = "CALL sp_rekap_agama('".$tahun."',".$bulan.")";
...
group by j.`jenis_pensiun_id`";
    ...
    function rekap_golongan_unit($tahun = NULL, $bulan = NULL, $status = 0) {
        $query = "SELECT 
COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
COALESCE(v.`unit_id`,u.`unit_id`) AS unit_id,u.`unit_kpok`,
SUM(IF(p.`pegawai_status_kepegawaian_id` <> '$status',1,0)) AS jumlah,
...
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'I' AND g.pangkat_golongan_ruang = 'a',1,0)) AS perempuan_gol_1a,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'I' AND g.pangkat_golongan_ruang = 'b',1,0)) AS perempuan_gol_1b,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'I' AND g.pangkat_golongan_ruang = 'c',1,0)) AS perempuan_gol_1c,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'I' AND g.pangkat_golongan_ruang = 'd',1,0)) AS perempuan_gol_1d,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'II' AND g.pangkat_golongan_ruang = 'a',1,0)) AS perempuan_gol_2a,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'II' AND g.pangkat_golongan_ruang = 'b',1,0)) AS perempuan_gol_2b,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'II' AND g.pangkat_golongan_ruang = 'c',1,0)) AS perempuan_gol_2c,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'II' AND g.pangkat_golongan_ruang = 'd',1,0)) AS perempuan_gol_2d,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'III' AND g.pangkat_golongan_ruang = 'a',1,0)) AS perempuan_gol_3a,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'III' AND g.pangkat_golongan_ruang = 'b',1,0)) AS perempuan_gol_3b,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'III' AND g.pangkat_golongan_ruang = 'c',1,0)) AS perempuan_gol_3c,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'III' AND g.pangkat_golongan_ruang = 'd',1,0)) AS perempuan_gol_3d,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'IV' AND g.pangkat_golongan_ruang = 'a',1,0)) AS perempuan_gol_4a,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'IV' AND g.pangkat_golongan_ruang = 'b',1,0)) AS perempuan_gol_4b,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'IV' AND g.pangkat_golongan_ruang = 'c',1,0)) AS perempuan_gol_4c,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'IV' AND g.pangkat_golongan_ruang = 'd',1,0)) AS perempuan_gol_4d,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'V' AND g.pangkat_golongan_ruang = 'a',1,0)) AS perempuan_gol_5a,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'V' AND g.pangkat_golongan_ruang = 'b',1,0)) AS perempuan_gol_5b,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'V' AND g.pangkat_golongan_ruang = 'c',1,0)) AS perempuan_gol_5c,
SUM(IF(p.`pegawai_jenkel_id` = '2' AND p.`pegawai_status_kepegawaian_id` <> '$status' AND g.pangkat_golongan_golongan = 'V' AND g.pangkat_golongan_ruang = 'd',1,0)) AS perempuan_gol_5d
FROM pegawai_rekap p
INNER JOIN ref_unit u ON p.`pegawai_unit_id` = u.`unit_id`
LEFT JOIN v_unit_kerja v ON (u.`unit_kpok` = v.`unit_kpok`)
LEFT JOIN ref_pangkat_golongan g ON (p.pegawai_pangkat_terakhir_id = g.`pangkat_golongan_id`)
...
ORDER BY unit_id";
    ...
    function rekap_pns_golongan_unit($tahun = NULL, $bulan = NULL, $status = 2) {
        $query = "SELECT 
COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
COALESCE(v.`unit_id`,u.`unit_id`) AS unit_id,u.`unit_kpok`,
SUM(IF(p.`pegawai_status_kepegawaian_id` ='$status',1,0)) AS jumlah,
...
ORDER BY unit_id";
    ...
    function rekap_cpns_golongan_unit($tahun = NULL, $bulan = NULL, $status = 1) {
        $query = "SELECT 
COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
COALESCE(v.`unit_id`,u.`unit_id`) AS unit_id,u.`unit_kpok`,
SUM(IF(p.`pegawai_status_kepegawaian_id` ='$status',1,0)) AS jumlah,
...
ORDER BY unit_id";
    ...
    function rekap_pppk_golongan_unit($tahun = NULL, $bulan = NULL, $status = 8) {
        $query = "SELECT 
COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
COALESCE(v.`unit_id`,u.`unit_id`) AS unit_id,u.`unit_kpok`,
SUM(IF(p.`pegawai_status_kepegawaian_id` ='$status',1,0)) AS jumlah,
...
ORDER BY unit_id";
    ...
    function rekap_pendidikan_unit($tahun = NULL, $bulan = NULL, $status = 0) {
        $query = "SELECT t.`pendidikan_tingkat_nama` AS pendidikan,
        COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1',1,0)) AS laki ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2',1,0)) AS perempuan ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '1',1,0) ) AS laki_sd ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '2',1,0) ) AS laki_smp ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '3',1,0) ) AS laki_sma ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '4',1,0) ) AS laki_d1 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '5',1,0) ) AS laki_d2 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '6',1,0) ) AS laki_d3 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '7',1,0) ) AS laki_d4 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '8',1,0) ) AS laki_s1 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '9',1,0) ) AS laki_s2 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '10',1,0) ) AS laki_s3 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '1',1,0) ) AS perempuan_sd ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '2',1,0) ) AS perempuan_smp ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '3',1,0) ) AS perempuan_sma ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '4',1,0) ) AS perempuan_d1 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '5',1,0) ) AS perempuan_d2 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '6',1,0) ) AS perempuan_d3 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '7',1,0) ) AS perempuan_d4 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '8',1,0) ) AS perempuan_s1 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '9',1,0) ) AS perempuan_s2 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status' AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '10',1,0) ) AS perempuan_s3 ,
SUM(IF(`pegawai_status_kepegawaian_id` <> '$status',1,0)) AS jumlah ,
COUNT(pegawai_nip) AS total 
FROM pegawai_rekap p
INNER JOIN ref_unit u ON p.`pegawai_unit_id` = u.`unit_id`
LEFT JOIN v_unit_kerja v ON (u.`unit_kpok` = v.`unit_kpok`)
...
ORDER BY v.unit_id";
    ...
    function rekap_cpns_pendidikan_unit($tahun = NULL, $bulan = NULL, $status = 1) {
        $query = "SELECT t.`pendidikan_tingkat_nama` AS pendidikan,
        COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1',1,0)) AS laki ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2',1,0)) AS perempuan ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '1',1,0) ) AS laki_sd ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '2',1,0) ) AS laki_smp ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '3',1,0) ) AS laki_sma ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '4',1,0) ) AS laki_d1 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '5',1,0) ) AS laki_d2 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '6',1,0) ) AS laki_d3 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '7',1,0) ) AS laki_d4 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '8',1,0) ) AS laki_s1 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '9',1,0) ) AS laki_s2 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1' AND pendidikan_tingkat_id = '10',1,0) ) AS laki_s3 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '1',1,0) ) AS perempuan_sd ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '2',1,0) ) AS perempuan_smp ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '3',1,0) ) AS perempuan_sma ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '4',1,0) ) AS perempuan_d1 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '5',1,0) ) AS perempuan_d2 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '6',1,0) ) AS perempuan_d3 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '7',1,0) ) AS perempuan_d4 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '8',1,0) ) AS perempuan_s1 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '9',1,0) ) AS perempuan_s2 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2' AND pendidikan_tingkat_id = '10',1,0) ) AS perempuan_s3 ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status'),1,0)) AS jumlah ,
COUNT(pegawai_nip) AS total 
FROM pegawai_rekap p
INNER JOIN ref_unit u ON p.`pegawai_unit_id` = u.`unit_id`
...
ORDER BY v.unit_id";
    ...
    function rekap_pns_pendidikan_unit($tahun = NULL, $bulan = NULL, $status = 2) {
        $query = "SELECT t.`pendidikan_tingkat_nama` AS pendidikan,
        COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1',1,0)) AS laki ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2',1,0)) AS perempuan ,
...
ORDER BY v.unit_id";
    ...
    function rekap_pppk_pendidikan_unit($tahun = NULL, $bulan = NULL, $status = 8) {
        $query = "SELECT t.`pendidikan_tingkat_nama` AS pendidikan,
        COALESCE(v.`unit_nama`,u.`unit_nama`) AS unit_nama,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='1',1,0)) AS laki ,
SUM(IF(`pegawai_status_kepegawaian_id` IN ('$status') AND `pegawai_jenkel_id` ='2',1,0)) AS perempuan ,
