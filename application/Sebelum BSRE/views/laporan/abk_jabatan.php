                    ...
                    <div class="modal-content">
                        <form role="form" action="<?= site_url('laporan/AbkJabatan/add') ?>" id="form-bagan-add" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group" id="div-sub-unit" style="display: none;">
                                    <label>Sub Unit</label>
                                    <select class="form-control select2" style="width: 100%" name="abkjabatan_sub_unit_id" id="abkjabatan_sub_unit_id">
                    ...
                    <div class="modal-content">
                        <form role="form" id="form-bagan-edit" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group" id="edit_div-sub-unit" style="display: none;">
                                    <label>Sub Unit</label>
                                    <select class="form-control select2" style="width: 100%" name="abkjabatan_sub_unit_id" id="edit_abkjabatan_sub_unit_id">
                                        <option value="0">--Pilih Sub Unit--</option>
                                        <?php
                                        foreach ($sub_unit->result() as $value) {
                                        ?>
...
<!--                                 <div class="form-group">
            ...
            <script>
                ...
                function edit(abkjabatan_id, abkjabatan_parent_id, abkjabatan_unit_id, abkjabatan_jabatan_id, abkjabatan_level, abkjabatan_kebutuhan, abkjabatan_bezzeting, abkjabatan_jenis_jabatan_id, abkjabatan_sub_unit_id) {
                    ...
                    $('#edit_abkjabatan_sub_unit_id').val(abkjabatan_sub_unit_id).change();
