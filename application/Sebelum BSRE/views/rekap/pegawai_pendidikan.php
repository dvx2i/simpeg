        ...
        <div class="row" id="pendidikan">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Jumlah Pegawai Menurut Pendidikan <?= $unit != null ? $unit : ''; ?>
                    </div>
                    <div class="panel-body">
        ...
        <thead>
            <tr>
                <th colspan="6" rowspan="2"><b>
                        <center>Rekap Pegawai Berdasarkan Pendidikan</center</b> </th> </tr> <tr>
            </tr>
            <tr>
                <th><b>No</b></th>
                <th><b>Unit</b></th>
...
<script>
    ...
    $('#excel-btn').click(function() {
        $("#example").table2excel({
            ...
            name: "Rekap_Pegawai_Berdasarkan_Pendidikan",
            filename: "Rekap_Pegawai_Berdasarkan_Pendidikan.xls", // do include extension
...
<?php if ($jenis == '1') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah Pegawai Menurut Tingkat Pendidikan (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        ...
        $(function() {
            ...
            foreach ($rekap_pendidikan->result_array() as $key) : ?>
                var barChart<?= $no++; ?> = {
                    ...
                    title: {
                        text: 'Jumlah Pegawai Menurut Pendidikan (Perbandingan) ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah Pegawai Menurut Pendidikan (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
...
<?php if ($jenis == '2') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah Pegawai Menurut Tingkat Pendidikan (Perkembangan) <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        //         text: 'sipedas.sanggau.go.id</a>'
        //     },
        ...
        $(function() {
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah Pegawai Menurut Pendidikan (Perkembangan)  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
