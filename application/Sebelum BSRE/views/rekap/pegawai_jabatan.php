            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?= site_url('rekap/PegawaiJabatan/view') ?>" method="post">
                            ...
                            <div class="form-group">
                                <div class="input-group-addon">
                                    ...
                                    <div class="col-lg-4" id="jabatan-div" style="display: none;">
                                        <div class="input-group">
                                            <span class="input-group-btn">
                                                <div class="btn btn-default">Jabatan &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
                                            </span>
                                            <select class="form-control " name="jabatan" id="jabatan">
                                                <?php foreach ($list_jabatan->result_array() as $key) : ?>
                                                    <option value="<?= $key['jabatan'] ?>" <?= selected($key['jabatan'], $jabatan, TRUE) ?>><?= $key['jabatan'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" style="text-align: right;">
                                        ...
                                        <!-- <?php
                                                ...
                                                ?>
                                            <a href="<?= site_url('rekap/PegawaiJabatan/update') ?>" type="button" class="btn btn-warning"><i class="fa fa-save fa-fw"></i> Update Rekap Terbaru</a>
                                        <?php
                                                }
                                        ?> -->
                                    </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div style="float: right;padding-top: 3px;padding-right: 13px">
                        ...
                        <!-- <a href="<?= site_url('rekap/PegawaiJabatan/excel/jabatan/' . $tahun . '/' . $bulan) ?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</a> -->
                    </div>
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Jumlah PNS Menurut Golongan Ruang <?= $unit != null ? $unit : ''; ?>
                    </div>
                    <div class="panel-body">
                        <div id="chart_jabatan" width="100" height="100"></div>
...
<?php if ($jenis == '1') : ?>
    <table style="display: none;" id="example" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th colspan="6" rowspan="2"><b>
                        <center>Rekap PNS Berdasarkan Jabatan</center</b> </th> </tr> <tr>
            </tr>
            <tr>
                <th><b>No</b></th>
                <th><b>Unit</b></th>
        ...
        <tbody>
            ...
            ?>
                    <?php
                    foreach ($rekap_jabatan_unit->result() as $value2) {
                        if ($value->jabatan == $value2->jabatan) {
                    ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $value2->unit ?></td>
                    ...
                    <tr>
                        <td colspan="5">
                            <center><b>Jumlah <?= $value->jabatan ?></b></center>
                        </td>
...
<script>
    ...
    $('#excel-btn').click(function() {
        $("#example").table2excel({
            ...
            name: "Rekap_PNS_Berdasarkan_Jabatan",
            filename: "Rekap_PNS_Berdasarkan_Jabatan.xls", // do include extension
...
<?php if ($jenis == '1') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah PNS Menurut Jabatan (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        ...
        //         data: [
        //             <?php foreach ($rekap_jabatan->result_array() as $key) : ?> {
        //                     name: "<?= $key['jabatan'] ?>",
        //                     y: <?= $key['jumlah'] ?>,
        //                     drilldown: "<?= 'jumlah' . $key['jabatan'] ?>"
        //                 },
        //             <?php endforeach; ?>
        //         ]
        //     }, {
        ...
        //             <?php foreach ($rekap_jabatan->result_array() as $key) : ?> {
        //                     y: <?= $key['perempuan'] ?>,
        //                     drilldown: "<?= 'perempuan' . $key['jabatan'] ?>"
        //                 },
        //             <?php endforeach; ?>
        //         ]
        //     }, ],
        ...
        //                     type: 'bar',
        //                     // inverted: true,
        //                     id: "<?= 'jumlah' . $key['jabatan'] ?>",
        //                     data: [
        //                         <?php foreach ($rekap_jabatan_unit->result_array() as $key2) : ?>
        //                             <?php if ($key['jabatan'] == $key2['jabatan']) : ?> {
        //                                     name: "<?= $key2['unit'] ?>",
        //                                     y: <?= $key2['jumlah'] ?>,
        //                                 },
        //                             <?php endif; ?>
        ...
        $(function() {
            ...
            // set chart options
            <?php $no = 1;
            foreach ($rekap_jabatan->result_array() as $key) : ?>
                var barChart<?= $no++; ?> = {
                    series: [
                    ...
                    xAxis: {
                        categories: [
                            <?php foreach ($rekap_jabatan_unit->result_array() as $key2) : ?>
                                <?php if ($key['jabatan'] == $key2['jabatan']) : ?> '<?= $key2['unit'] ?>',
                                <?php endif; ?>
                            <?php endforeach; ?>
                        ]
                    },
                    ...
                    title: {
                        text: 'Jumlah PNS Menurut Jabatan (Perbandingan) ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
            ...
            // create the chart
            $('#chart_jabatan').highcharts($.extend(true, {}, colChart));
        });
    </script>
<?php endif ?>
...
<?php if ($jenis == '2') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah PNS Menurut Jabatan (Perkembangan) <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        //         text: 'sipedas.sanggau.go.id</a>'
        //     },
