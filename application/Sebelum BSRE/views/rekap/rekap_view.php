                            ...
                            <div class="form-group">
                                <div class="input-group-addon">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <a href="#" onclick="update()" type="button" class="btn btn-warning"><i class="fa fa-save fa-fw"></i> Update Rekap Terbaru</a>
...
<script>
	...
	function update(){
          ...
          var form = "<form id='hidden-form' action='<?= site_url('rekap/RekapPns/update/')?>' method='post'>";
