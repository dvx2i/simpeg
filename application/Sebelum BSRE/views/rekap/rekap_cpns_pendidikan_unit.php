        ...
        <div class="row" id="golru">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Rekap CPNS Pendidikan Umum dan Jenis Kelamin                        
                    </div>
                    <div class="panel-body" id="target_print">
                        ...
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td>
                                    <p align="center"><b>JUMLAH CALON PEGAWAI NEGERI SIPIL DIRINCI MENURUT PENDIDIKAN UMUM DAN JENIS KELAMIN
...
<script>
   ...
   //getting values of current time for generating the file name
        ...
        a.download = 'Rekap_CPNS_Pendidikan_Umum_' + postfix + '.xls';
