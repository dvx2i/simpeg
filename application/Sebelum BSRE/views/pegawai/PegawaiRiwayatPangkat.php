...
class PegawaiRiwayatPangkat extends MY_Controller
{
    ...
    function add($return = NULL)
    {
        ...
        $data['pegawaipangkat_pangkat_nama'] = $this->ref_pangkat_golongan->get_pangkat_by_kode($data['pegawaipangkat_pangkat_id'])->pangkat_golongan_pangkat;
        $data['pegawaipangkat_pangkat_golru'] = $this->ref_pangkat_golongan->get_pangkat_by_kode($data['pegawaipangkat_pangkat_id'])->pangkat_golongan_nama;
