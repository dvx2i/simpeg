...
class PegawaiRiwayatJabatan extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('m_pegawai_jabatan','m_bagan_struktur','m_abk_jabatan', 'ref_eselon','ref_kelas_jabatan', 'ref_kenaikan_jabatan', 'ref_kondisi_sumpah', 'ref_pangkat_golongan', 'ref_jabatan_fungsional', 'ref_jabatan_baru', 'ref_jabatan_struktural', 'ref_jabatan_kedudukan', 'm_pegawai', 'ref_unit', 'ref_pejabat'));
    ...
    function add($return = NULL)
    {
        ...
        if ($data['pegawaijabatan_jenisjabatan_id'] == '1') {
            $jabatan_lama = $this->ref_jabatan_struktural->get_row($pegawai->pegawai_jabatan_id);
