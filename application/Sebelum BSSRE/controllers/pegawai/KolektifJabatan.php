...
class KolektifJabatan extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('m_pegawai_jabatan', 'ref_eselon', 'ref_kenaikan_jabatan', 'ref_kondisi_sumpah', 'ref_pangkat_golongan', 'ref_jabatan_fungsional', 'ref_jabatan_struktural', 'ref_jabatan_kedudukan', 'm_pegawai', 'ref_unit', 'ref_pejabat', 'm_abk_jabatan'));
        if (!$this->cek_admin()) {
    ...
    private function update_jabatan_terakhir($nip, $pegawaijabatan_kenaikan_id)
    {
        ...
        $kenaikan = $this->ref_kenaikan_jabatan->get_row($pegawaijabatan_kenaikan_id);
        $pegawai = $this->m_pegawai->get_row($nip);

        if($kenaikan->kenaikan_jabatan_pengurangan == '1'){
            
            $jenis_lama = $pegawai->pegawai_jenisjabatan_kode;
            $jabatan_lama = $pegawai->pegawai_jabatan_id;
            $unit_id_lama= $pegawai->pegawai_unit_id;
            $sub_unit_id_lama= $pegawai->pegawai_unit_id;
            $jenis_baru = 0;
            $jabatan_baru = 0;
            $unit_id_baru = 0;
            $sub_unit_id_baru = 0;
            $this->m_abk_jabatan->update_by_mutasi_pensiun($jenis_lama,$jabatan_lama,$jenis_baru,$jabatan_baru,$unit_id_lama,$unit_id_baru,$sub_unit_id_lama,$sub_unit_id_baru);
            ...
            $jabatan_lama = $pegawai->pegawai_jabatan_id;
            $unit_id_lama= $pegawai->pegawai_unit_id;
            $sub_unit_id_lama= $pegawai->pegawai_sub_unit_id;
            $jenis_baru = $data['pegawai_jenisjabatan_kode'];
            $jabatan_baru = $data['pegawai_jabatan_id'];
            $unit_id_baru = $data['pegawai_unit_id'];
            $sub_unit_id_baru = $data['pegawai_sub_unit_id'];
            $this->m_abk_jabatan->update_by_jabatan($jenis_lama,$jabatan_lama,$jenis_baru,$jabatan_baru,$unit_id_lama,$unit_id_baru,$sub_unit_id_lama,$sub_unit_id_baru);
