 ...
 * @author Zanuar
 */
class PegawaiGolru extends CI_Controller
{
    ...
    function index()
    {
        ...
        $data['bulan2']  = '';
        $data['golru']  = '';
        $data = $this->m_pegawai_rekap_golru->data($data['tahun'], $data['bulan'], $data['unit'], $data['jenis'], $data['periode'], $data['tahun2'], $data['bulan2'], $data['golru']);
        $data["content"] = $this->load->view('publik/pegawai_golru', $data, TRUE);
