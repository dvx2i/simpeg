 ...
 * @author Zanuar
 */
class PppkPendidikanUnit extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_pppk_pendidikan_unit($data['tahun'], $data['bulan']);
        
        $data['rekap_pendidikan'] = $this->m_pegawai_rekap_pendidikan->get_rekap_pendidikan_pppk($data['tahun'], $data['bulan'], $data['unit'], '');
        $data['rekap_pendidikan_unit'] = $this->m_pegawai_rekap_pendidikan->get_rekap_pendidikan_pppk_unit($data['tahun'], $data['bulan'], $data['unit'], '');
        $this->loadView('rekap/rekap_pppk_pendidikan_unit', $data);
    }
