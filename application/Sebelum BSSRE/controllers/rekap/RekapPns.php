...
class RekapPns extends MY_Controller {
    ...
    function update() {
        $data['tahun'] = $this->input->post('tahun');
        $data['bulan'] = $this->input->post('bulan');
        $this->m_pegawai_rekap->update_now($data['tahun'], $data['bulan']);
    // die($this->db->last_query());
    	$this->m_pegawai_rekap->update_rekap_agama($data['tahun'], $data['bulan']);
    	$this->m_pegawai_rekap->update_rekap_eselon($data['tahun'], $data['bulan']);
    	$this->m_pegawai_rekap->update_rekap_golru($data['tahun'], $data['bulan']);
    	$this->m_pegawai_rekap->update_rekap_jabatan($data['tahun'], $data['bulan']);
    	$this->m_pegawai_rekap->update_rekap_jk($data['tahun'], $data['bulan']);
    	$this->m_pegawai_rekap->update_rekap_pendidikan($data['tahun'], $data['bulan']);
