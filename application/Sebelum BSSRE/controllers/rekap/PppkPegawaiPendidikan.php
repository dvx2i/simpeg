 ...
 * @author Zanuar
 */
class PppkPegawaiPendidikan extends MY_Controller
{
    ...
    function index()
    {
        ...
        $data['bulan2']  = '';
        $data['pendidikan']  = '';
        $data = $this->m_pegawai_rekap_pendidikan->data_pppk($data['tahun'], $data['bulan'], $data['unit'], $data['jenis'], $data['periode'], $data['tahun2'], $data['bulan2'], $data['pendidikan']);
        $this->loadView('rekap/pppk_pegawai_pendidikan', $data);
    }
