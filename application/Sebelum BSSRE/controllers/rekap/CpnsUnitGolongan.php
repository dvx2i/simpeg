 ...
 * @author Zanuar
 */
class CpnsUnitGolongan extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_unit_golongan_eselon_jenis_kelamin($data['tahun'], $data['bulan'],1);
        $this->loadView('rekap/rekap_cpns_unit_golongan', $data);
    }
