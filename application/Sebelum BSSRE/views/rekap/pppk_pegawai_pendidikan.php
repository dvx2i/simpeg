...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            Rekap Jumlah PPPK Menurut Tingkat Pendidikan
        </h1>
    </section>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?= site_url('rekap/PppkPegawaiPendidikan/view') ?>" method="post">
        ...
        <div class="row" id="pendidikan">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Jumlah PPPK Menurut Pendidikan <?= $unit != null ? $unit : ''; ?>
                    </div>
                    <div class="panel-body">
        ...
        <thead>
            <tr>
                <th colspan="6" rowspan="2"><b>
                        <center>Rekap PPPK Berdasarkan Pendidikan</center</b> </th> </tr> <tr>
            </tr>
            <tr>
                <th><b>No</b></th>
                <th><b>Unit</b></th>
...
<script>
    ...
    $('#excel-btn').click(function() {
        $("#example").table2excel({
            ...
            name: "Rekap_PPPK_Berdasarkan_Pendidikan",
            filename: "Rekap_PPPK_Berdasarkan_Pendidikan.xls", // do include extension
...
<?php if ($jenis == '1') : ?>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah PPPK Menurut Tingkat Pendidikan   <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        ...
        $(function() {
            ...
            foreach ($rekap_pendidikan->result_array() as $key) : ?>
                var barChart<?= $no++; ?> = {
                    ...
                    title: {
                        text: 'Jumlah PPPK Menurut Pendidikan  ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah PPPK Menurut Pendidikan   <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
