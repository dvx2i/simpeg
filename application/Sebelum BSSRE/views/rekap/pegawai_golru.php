...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            Rekap Jumlah Pegawai Menurut Golongan Ruang
        </h1>
    </section>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?= site_url('rekap/CpnsPegawaiGolru/view') ?>" method="post">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div style="float: right;padding-top: 3px;padding-right: 13px">
                        ...
                        <!-- <a href="<?= site_url('rekap/CpnsPegawaiGolru/excel/golru/' . $tahun . '/' . $bulan) ?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</a> -->
                    </div>
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Jumlah Pegawai Menurut Golongan Ruang <?= $unit != null ? $unit : ''; ?>
                    </div>
                    <div class="panel-body">
        ...
        <thead>
            <tr>
                <th colspan="6" rowspan="2"><b>
                        <center>Rekap Pegawai Berdasarkan Gologan Ruang</center</b> </th> </tr> <tr>
            </tr>
            <tr>
                <th><b>No</b></th>
                <th><b>Unit</b></th>
...
<script>
    ...
    $('#excel-btn').click(function() {
        ...
        $("#example").table2excel({
            ...
            name: "Rekap_Pegawai_Berdasarkan_Golongan",
            filename: "Rekap_Pegawai_Berdasarkan_golru.xls", // do include extension
...
<?php if ($jenis == '1') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah Pegawai Menurut Golongan Ruang (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        ...
        $(function() {
                ...
                var barChart<?= $no++; ?> = {
                    series: [

                        {
                            name: 'Laki-laki',
                            data: [
                                <?php foreach ($rekap_golru->result_array() as $key2) : ?>
                                    <?php if ($key['golru'] == $key2['golru']) : ?>
                                        <?= $key2['laki'] ?>,
                                    <?php endif; ?>
                                <?php endforeach; ?>
                    ...
                    title: {
                        text: 'Jumlah Pegawai Menurut Golongan Ruang ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah Pegawai Menurut Golongan Ruang  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
...
<?php /* if ($jenis == '2') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah Pegawai Menurut Golongan Ruang (Perkembangan) <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        //         text: 'sipedas.sanggau.go.id</a>'
        //     },
        ...
        $(function() {
            ...
            <?php foreach ($rekap_golru->result_array() as $key) : ?>
                var barChart<?= $key['name'] ?> = {
                    ...
                    title: {
                        text: 'Jumlah Pegawai Menurut Golongan Ruang (Perbandingan) ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
