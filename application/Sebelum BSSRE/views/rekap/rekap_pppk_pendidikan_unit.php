        ...
        <div class="row" id="golru">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Rekap PPPK Pendidikan Umum dan Jenis Kelamin                        
                    </div>
                    <div class="panel-body" id="target_print">
                        ...
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td>
                                    <p align="center"><b>JUMLAH PEGAWAI PEMERINTAH DENGAN PERJANJIAN KERJA DIRINCI MENURUT PENDIDIKAN UMUM DAN JENIS KELAMIN
                        ...
                        <table width="100%" border="1" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="18" scope="col">PENDIDIKAN / JENIS KELAMIN</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    $total = array('jumlah'=>0,
                                        'laki_sd'=>0,'laki_smp'=>0,'laki_sma'=>0,
                                        'laki_d1'=>0,'laki_d2'=>0,'laki_d3'=>0,
                                        'laki_d4'=>0,'laki_s1'=>0,'laki_s2'=>0,'laki_s3'=>0,'laki'=>0,
                                        'perempuan_sd'=>0,'perempuan_smp'=>0,'perempuan_sma'=>0,
                                        'perempuan_d1'=>0,'perempuan_d2'=>0,'perempuan_d3'=>0,
                                        'perempuan_d4'=>0,'perempuan_s1'=>0,'perempuan_s2'=>0,'perempuan_s3'=>0,'perempuan'=>0);

                                    foreach ($result->result() as $value) {
                                         $total['jumlah'] += $value->jumlah ;
                                             $total['laki_sd'] += $value->laki_sd ;
                                             $total['laki_smp'] += $value->laki_smp ;
                                             $total['laki_sma'] += $value->laki_sma ;
                                             $total['laki_d1'] += $value->laki_d1 ;
                                             $total['laki_d2'] += $value->laki_d2 ;
                                             $total['laki_d3'] += $value->laki_d3 ;
                                             $total['laki_d4'] += $value->laki_d4 ;
                                             $total['laki_s1'] += $value->laki_s1 ;
                                             $total['laki_s2'] += $value->laki_s2 ;
                                             $total['laki_s3'] += $value->laki_s3 ;
                                             $total['laki'] += $value->laki ;
                                             $total['perempuan_sd'] += $value->perempuan_sd ;
                                             $total['perempuan_smp'] += $value->perempuan_smp ;
                                             $total['perempuan_sma'] += $value->perempuan_sma ;
                                             $total['perempuan_d1'] += $value->perempuan_d1 ;
                                             $total['perempuan_d2'] += $value->perempuan_d2 ;
                                             $total['perempuan_d3'] += $value->perempuan_d3 ;
                                             $total['perempuan_d4'] += $value->perempuan_d4 ;
                                             $total['perempuan_s1'] += $value->perempuan_s1 ;
                                             $total['perempuan_s2'] += $value->perempuan_s2 ;
                                             $total['perempuan_s3'] += $value->perempuan_s3 ;
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->jumlah ?></td>
                                            <td><?= $value->laki_sd ?></td>
                                            <td><?= $value->laki_smp ?></td>
                                            <td><?= $value->laki_sma ?></td>
                                            <td><?= $value->laki_d1 ?></td>
                                            <td><?= $value->laki_d2 ?></td>
                                            <td><?= $value->laki_d3 ?></td>
                                            <td><?= $value->laki_d4 ?></td>
                                            ...
                                            <td><?= $value->laki_s3 ?></td>
                                            <td><?= $value->laki ?></td>
                                            <td><?= $value->perempuan_sd ?></td>
                                            <td><?= $value->perempuan_smp ?></td>
                                            <td><?= $value->perempuan_sma ?></td>
                                            <td><?= $value->perempuan_d1 ?></td>
                                            <td><?= $value->perempuan_d2 ?></td>
                                            <td><?= $value->perempuan_d3 ?></td>
                                            <td><?= $value->perempuan_d4 ?></td>
                                            <td><?= $value->perempuan_s1 ?></td>
                                            <td><?= $value->perempuan_s2 ?></td>
                                            <td><?= $value->perempuan_s3 ?></td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $total['jumlah'] ?></td>
                                            <td><?= $total['laki_sd'] ?></td>
                                            <td><?= $total['laki_smp'] ?></td>
                                            <td><?= $total['laki_sma'] ?></td>
                                            <td><?= $total['laki_d1'] ?></td>
                                            <td><?= $total['laki_d2'] ?></td>
                                            <td><?= $total['laki_d3'] ?></td>
                                            <td><?= $total['laki_d4'] ?></td>
                                            ...
                                            <td><?= $total['laki_s3'] ?></td>
                                            <td><?= $total['laki'] ?></td>
                                            <td><?= $total['perempuan_sd'] ?></td>
                                            <td><?= $total['perempuan_smp'] ?></td>
                                            <td><?= $total['perempuan_sma'] ?></td>
                                            <td><?= $total['perempuan_d1'] ?></td>
                                            <td><?= $total['perempuan_d2'] ?></td>
                                            <td><?= $total['perempuan_d3'] ?></td>
                                            <td><?= $total['perempuan_d4'] ?></td>
                                            <td><?= $total['perempuan_s1'] ?></td>
                                            <td><?= $total['perempuan_s2'] ?></td>
                                            <td><?= $total['perempuan_s3'] ?></td>
...
<script>
   ...
   //getting values of current time for generating the file name
        ...
        a.download = 'Rekap_PPPK_Pendidikan_Umum_' + postfix + '.xls';
		  ...
		  '#E64D66', '#4DB380', '#FF4D4D', '#99E6E6', '#6666FF'];
            ...
            foreach ($rekap_pendidikan->result_array() as $key) : ?>
                var barChart<?= $no++; ?> = {
                    series: [

                        {
                            ...
                            data: [
                                <?php  $height = 0; foreach ($rekap_pendidikan_unit->result_array() as $key2) : ?>
                    ...
                    xAxis: {
                        categories: [
                            <?php foreach ($rekap_pendidikan_unit->result_array() as $key2) : ?>
                                <?php if ($key['pendidikan'] == $key2['pendidikan']) : ?> '<?= $key2['unit'] ?>',
                                <?php endif; ?>
                            <?php endforeach; ?>
                        ]
                    },
                ...
                plotOptions: {
                    ...
                    title: {
                        text: 'Jumlah PNS Menurut Pendidikan (Perbandingan) ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah PNS Menurut Pendidikan (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
