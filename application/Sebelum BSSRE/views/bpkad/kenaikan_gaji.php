    ...
    function d_m_y(date) {
        ...
        $(document).on('click', '.btn-sk', function(){
            ...
            success: function(data) {
                ...
                // console.log(data[0].kgbsk_file)
                var html = ' <a href="<?= base_url("assets/files/") ?>' + data[0].kgbsk_file + '" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-download"></i> <small>Unduh</small></a>';
                ...
                var berkasModal = '<object data="<?= base_url("assets/files/") ?>/' + data[0].kgbsk_file + '" type="application/pdf" width="100%" height="480px"></object>';
