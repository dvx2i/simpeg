...
<div id="price" class="content" data-scrollview="true" style="padding-top: 6rem;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 ">
                <div class="card">
                    ...
                    <div style="">
                        <div class="card-body">
                            <form role="form" action="<?= site_url('publik/PegawaiPendidikan/view') ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6" id="pendidikan-div" style="display: none;">
                                        <div class="input-group">
                                            <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12" style="text-align: right;">
                                        ...
                                        <!-- <?php
                                                ...
                                                ?>
                                            <a href="<?= site_url('publik/PegawaiPendidikan/update') ?>" type="button" class="btn btn-warning"><i class="fa fa-save fa-fw"></i> Update Rekap Terbaru</a>
                                        <?php
                                                }
                                        ?> -->
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">Jumlah PNS Menurut Pendidikan <?= $unit != null ? $unit : ''; ?></div>
                    <div style="">
                        <div class="card-body">
                            <div id="chart_jk"></div>
                            <center>
