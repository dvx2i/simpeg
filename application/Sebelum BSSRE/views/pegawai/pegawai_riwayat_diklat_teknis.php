        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body ">
                        <form id="formadd" role="form" action="<?= site_url('pegawai/PegawaiRiwayatDiklatTeknis/add') ?>" method="post" enctype="multipart/form-data">
                            <input name="nip" type="hidden" value="<?= $pegawai->pegawai_nip ?>" />
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <b> RIWAYAT DIKLAT TEKNIS</b>
                                    </div>
...
<!--                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="diklat_kode" id="diklat_kode">
                                                ...
                                                <?php
                                                foreach ($diklat_teknis->result() as $value) {
                                                ?>
                                                    <option value="<?= $value->diklat_teknis_id ?>"><?= $value->diklat_teknis_nama ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left nowrap">
                                                ...
                                                <a href="<?= site_url('pegawai/PegawaiRiwayatDiklatTeknis/delete/' . $value->diklat_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data.?')"><i class="fa fa-trash-o fa-fw"></i></a>
...
<script>
    ...
    function edit(v) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatDiklatTeknis/update') ?>');
    ...
    function refresh() {
        $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatDiklatTeknis/add') ?>');
