...
<div class="content-wrapper">
    ...
    <section class="content">
        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-add">A. DATA MUTASI</a>
        <?php if ($usulan_status == '2' || $usulan_status == '4') : ?> <a href="#" class="btn btn-primary" id="btn-bukti-usulan"">B. BUKTI USULAN MUTASI</a> <?php endif; ?>
        <br />
        <br />
        <div class="row">
            <div class="col-md-12">
...
<div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Bukti Usulan Mutasi</h4>
            </div>
            <div class="modal-body">
                <div id="bukti-usulan"></div>
            </div>
            <div class="modal-footer">
...
<script>
    PDFObject.embed("<?= $bukti_usulan_file ?>", "#bukti-usulan");
</script>
<script>
    $(document).ready(
    function() {

    // <?php if ($usulan_status == '2' || $usulan_status == '4') : ?> $('#myModal2').modal('show'); <?php endif; ?>
    ...
    $('#btn-bukti-usulan').click(function() {
        $('#myModal2').modal('show')
    });
    ...
    $('#btn-terima').click(function() {
        swal({
            ...
            if (isConfirm) {
                ...
                var form = "<form id='hidden-form' action='<?= site_url('mutasi/DataPengajuan/update/verify') ?>' method='post' target='_blank'>";
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    var form = "<form id='hidden-form' action='<?= site_url('mutasi/DataPengajuan/update/reject') ?>' method='post' target='_blank'>";
