            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" onsubmit="return loading()" action="<?php echo site_url('konversi/TpJabatan/add'); ?>" enctype="multipart/form-data" method="POST">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <a href="<?= base_url('assets/files/excel/TP_JABATAN.xlsx')?>" target="_blank"><i class="fa fa-file-excel-o"></i> Dowload Format Excel Disini</a>
                                </div>
