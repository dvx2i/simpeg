...
class AbkJabatan extends MY_Controller
{
            ...
            if (!empty($this->input->post('pegawai_unit_id'))) {
                ...
                if ($this->input->post('jenis') == 'bagan') {
                    ...
                    for($i=0; $i < count($bagan); $i++){
                        ...
                        $data['bagan'][$i]['pegawai'] = $this->m_abk_jabatan->get_pegawai_by_jabatan($bagan[$i]['abkjabatan_unit_id'],$bagan[$i]['abkjabatan_jenis_jabatan_id'],$bagan[$i]['abkjabatan_jabatan_id']);
                    }
    ...
    public function add()
    {
        ...
        $data['abkjabatan_bezzeting'] = $this->m_abk_jabatan->get_bezzeting($data['abkjabatan_unit_id'],$data['abkjabatan_jenis_jabatan_id'], $data['abkjabatan_jabatan_id']);
