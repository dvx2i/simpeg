    ...
    public function add() {
        ...
        foreach ($allDataInSheet as $value) {
            ...
            if ($row > 0) {
                ...
                $data['pegawai_cpns_sk_date'] = tanggal_mysql($value['D'],'/');
                $data['pegawai_cpns_tmt'] = tanggal_mysql($value['E'],'/');
                $data['pegawai_cpns_pangkat_id'] = $value['F'];
                $data['pegawai_pns_pejabat'] = $value['M'];
                $data['pegawai_pns_sk_no'] = $value['N'];
                $data['pegawai_pns_sk_date'] = tanggal_mysql($value['O'],'/');
                $data['pegawai_pns_tmt'] = tanggal_mysql($value['P'],'/');
                $data['pegawai_pns_pangkat_id'] = $value['Q'];
                $data['pegawai_pns_sumpah_id'] = $value['R'];
