...
{
    function abk_action($abkjabatan_id,$abkjabatan_parent_id,$abkjabatan_unit_id,$abkjabatan_jabatan_id,$abkjabatan_level,$abkjabatan_kebutuhan,$abkjabatan_bezzeting,$abkjabatan_jenis_jabatan_id)
    {
      return '<a href="#" class="btn btn-warning btn-sm" type="button" onclick="edit(\''.$abkjabatan_id.'\',\''.$abkjabatan_parent_id.'\',\''.$abkjabatan_unit_id.'\',\''.$abkjabatan_jabatan_id.'\',\''.$abkjabatan_level.'\',\''.$abkjabatan_kebutuhan.'\',\''.$abkjabatan_bezzeting.'\',\''.$abkjabatan_jenis_jabatan_id.'\')" data-toggle="modal" data-target="#modal-edit"><i class="fa fa-edit"></i></a>
...
{
    function aksi_kgb($kgb_id, $status, $nip, $nama)
    {
    	if($status == '1'){
    		...
    		return '<a href="#" class="btn btn-primary btn-sm" type="button" onclick="edit(\''.$nip.'\',\''.$nama.'\')" data-toggle="modal" data-target="#modal-update"><i class="fa fa-check"></i> Verifikasi</a>';
    	}
    }
