...
class PegawaiRiwayatPangkat extends MY_Controller
{
    ...
    function view($nip)
    {
        ...
        $data['berkas'] = $this->m_pegawai_pangkat_esign->get_where(array('pangkatsk_nip' => $nip));
    ...
    function update_pangkat_terakhir($nip)
    {
        ...
        $data1['pegawai_gaji'] = $pangkat_terakhir->pegawaipangkat_gaji_pokok;
