...
class PegawaiPensiun extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('ref_pejabat', 'ref_kondisi_sumpah', 'ref_jenis_pensiun', 'ref_pangkat_golongan', 'ref_jabatan_fungsional', 'ref_jabatan_struktural', 'ref_jabatan_kedudukan', 'ref_status_kepegawaian', 'm_pegawai', 'ref_unit', 'ref_jenis_kelamin', 'ref_golongan_darah', 'ref_agama', 'ref_status_perkawinan','m_bagan_struktur','m_abk_jabatan'));
        if (!$this->cek_admin()) {
    ...
    function update()
    {
        ...
        $pegawai = $this->m_pegawai->get_row($id);
