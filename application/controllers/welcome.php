...
class Welcome extends MY_Controller {
    ...
    function index()
    {
        ...
        if($session['group_id'] == '7'){
            $this->loadView('bpkad/home',$data);
        }elseif($session['group_id'] != '1'){
            $this->loadView('home_non_admin',$data);
        }else{
    ...
    function test()
    {
    	// echo shell_exec("php -v"); 
         $result = shell_exec("export HOME=/tmp/ && /usr/bin/libreoffice --headless --convert-to pdf '/var/www/html/assets/docs/test.docx' --outdir '/var/www/html/assets/docs'");
    var_dump($result);
