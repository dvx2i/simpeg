 ...
 * @author Zanuar
 */
class GolonganRuang extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_golongan_ruang($data['tahun'], $data['bulan']);
        $this->loadView('rekap/rekap_golongan_ruang', $data);
    }
