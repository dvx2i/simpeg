 ...
 * @author Zanuar
 */
class PnsPegawaiGolru extends MY_Controller
{
    ...
    function index()
    {
        ...
        $data['bulan2']  = '';
        $data['golru']  = '';
        $data = $this->m_pegawai_rekap_golru->data_pns($data['tahun'], $data['bulan'], $data['unit'], $data['jenis'], $data['periode'], $data['tahun2'], $data['bulan2'], $data['golru']);
        $this->loadView('rekap/pns_pegawai_golru', $data);
    }
