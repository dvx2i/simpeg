 ...
 * @author Zanuar
 */
class JabatanUnit extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_unit_golongan_eselon_jenis_kelamin($data['tahun'], $data['bulan']);
        $this->loadView('rekap/rekap_jabatan_unit', $data);
    }
