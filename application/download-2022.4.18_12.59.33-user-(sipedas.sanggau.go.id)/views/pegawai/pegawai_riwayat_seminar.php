        ...
        <div class="row" id="riwayat">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body ">
                        <form id="formadd" role="form" action="<?= site_url('pegawai/PegawaiRiwayatSeminar/add') ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left nowrap">
                                                ...
                                                <a href="<?= site_url('pegawai/PegawaiRiwayatSeminar/delete/' . $value->diklat_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data.?')"><i class="fa fa-trash-o fa-fw"></i></a>
...
<script>
    ...
    function edit(v) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatSeminar/update') ?>');
    ...
    function refresh() {
        $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatSeminar/add') ?>');
