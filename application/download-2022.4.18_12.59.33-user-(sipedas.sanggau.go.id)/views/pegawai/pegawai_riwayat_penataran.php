        ...
        <div class="row" id="riwayat">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body ">
                        <form id="formadd" role="form" action="<?= site_url('pegawai/PegawaiRiwayatPenataran/add') ?>" method="post" enctype="multipart/form-data">
                            <input name="nip" type="hidden" value="<?= $pegawai->pegawai_nip ?>" />
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <b> RIWAYAT PENATARAN</b>
                                    </div>
...
<!--                                             <input type="text" class="form-control" name="diklat_nama" id="diklat_nama" autocomplete="off" required="true" /> -->
                                        	<select name="diklat_nama" id="diklat_nama" class="form-control" required="true">
                                            	<option>Pilih</option>
                                            	<option value="Diklat prajab/latsar gol I">Diklat prajab/latsar gol I</option>
                                            	<option value="Diklat prajab/latsar gol II">Diklat prajab/latsar gol II</option>
                                            	<option value="Diklat prajab/latsar gol III">Diklat prajab/latsar gol III</option>
                                        	</select>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left nowrap">
                                                ...
                                                <a href="<?= site_url('pegawai/PegawaiRiwayatPenataran/delete/' . $value->diklat_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data.?')"><i class="fa fa-trash-o fa-fw"></i></a>
...
<script>
    ...
    function edit(v) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatPenataran/update') ?>');
    ...
    function refresh() {
        $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatPenataran/add') ?>');
