        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body ">
                        <form id="formadd" role="form" action="<?= site_url('pegawai/PegawaiRiwayatDiklatStruktural/add') ?>" method="post" enctype="multipart/form-data">
                            <input name="nip" type="hidden" value="<?= $pegawai->pegawai_nip ?>" />
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <b> RIWAYAT DIKLAT STRUKTURAL</b>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="diklat_kode" id="diklat_kode">
                                                <option value="">--Pilih--</option>
                                                <?php
                                                foreach ($diklat_struktural->result() as $value) {
                                                ?>
                                                    <option value="<?= $value->diklat_struktural_kode ?>"><?= $value->diklat_struktural_nama ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
...
<!--                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeyup="angka(this);" class="form-control" name="diklat_tahun" id="diklat_tahun" autocomplete="off" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left nowrap">
                                                ...
                                                <a href="<?= site_url('pegawai/PegawaiRiwayatDiklatStruktural/delete/' . $value->diklat_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus Data.?')"><i class="fa fa-trash-o fa-fw"></i></a>
...
<script>
    ...
    function edit(v) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatDiklatStruktural/update') ?>');
    ...
    function refresh() {
        $('#formadd').attr('action', '<?= site_url('pegawai/PegawaiRiwayatDiklatStruktural/add') ?>');
