            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?= site_url('rekap/PegawaiPendidikan/view') ?>" method="post">
                            ...
                            <div class="form-group">
                                <div class="input-group-addon">
                                    ...
                                    <div class="col-lg-4" id="pendidikan-div" style="display: none;">
                                        <div class="input-group">
                                            <span class="input-group-btn">
                                                <div class="btn btn-default">Pendidikan &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
                                            </span>
                                            <select class="form-control " name="pendidikan" id="pendidikan">
                                                <?php foreach ($list_pendidikan->result_array() as $key) : ?>
                                                    <option value="<?= $key['pendidikan'] ?>" <?= selected($key['pendidikan'], $pendidikan, TRUE) ?>><?= $key['pendidikan'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" style="text-align: right;">
                                        ...
                                        <!-- <?php
                                                ...
                                                ?>
                                            <a href="<?= site_url('rekap/PegawaiPendidikan/update') ?>" type="button" class="btn btn-warning"><i class="fa fa-save fa-fw"></i> Update Rekap Terbaru</a>
                                        <?php
                                                }
                                        ?> -->
                                    </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div style="float: right;padding-top: 3px;padding-right: 13px">
                        ...
                        <!-- <a href="<?= site_url('rekap/PegawaiPendidikan/excel/pendidikan/' . $tahun . '/' . $bulan) ?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</a> -->
                    </div>
                    <div class="panel-heading">
...
<?php if ($jenis == '1') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah PNS Menurut Tingkat Pendidikan (Perbandingan)  <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
...
<?php if ($jenis == '2') : ?>
    <script>
        ...
        //     },
        //     title: {
        //         text: 'Jumlah PNS Menurut Tingkat Pendidikan (Perkembangan) <?= $unit != null ? $unit : ''; ?>'
        //     },
        //     subtitle: {
        //         text: 'sipedas.sanggau.go.id</a>'
        //     },
        ...
        $(function() {
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah PNS Menurut Pendidikan (Perkembangan)  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
