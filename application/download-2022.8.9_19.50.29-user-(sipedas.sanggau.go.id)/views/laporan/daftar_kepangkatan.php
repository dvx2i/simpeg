            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div style="float: right;padding-top: 3px;padding-right: 13px">
                        <form action="<?= site_url('laporan/DaftarKepangkatan/excel/') ?>" target="_blank" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Daftar Kepangkatan Menurut Jenis Kelamin
                    </div>
