...
class M_pegawai_cuti_online extends MY_Model
{
    ...
    function json()
    {
      ...
      $this->datatables->select('pegawaicuti_id,pegawaicuti_pegawai_nip,pegawaicuti_no_permohonan,pegawai_nama,jenis_cuti_nama,pegawaicuti_status_permohonan,pegawaicuti_lama_cuti_mulai,pegawaicuti_lama_cuti_selesai,pegawaicuti_keterangan_tolak,file_sk,pegawaicuti_sk_no', FALSE);
      ...
      $this->datatables->edit_column('file_sk', '$1', 'sk_cuti(file_sk,pegawaicuti_status_permohonan)');
    //   $this->datatables->edit_column('file_sk', '$1', 'get_sk_mutasi(file_sk,usulan_status,"admin",usulan_id,insert_time)');
      ...
      $this->datatables->add_column('action', '$1', 'get_action_cuti(pegawaicuti_id,pegawaicuti_status_permohonan,pegawaicuti_sk_no)');
