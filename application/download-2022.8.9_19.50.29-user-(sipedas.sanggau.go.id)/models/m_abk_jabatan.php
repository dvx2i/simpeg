...
class M_abk_jabatan extends MY_Model
{
    ...
    function json($param = null)
    {
        ...
        $this->datatables->select("a.abkjabatan_id,a.abkjabatan_jenis_jabatan_id,a.abkjabatan_jabatan_id,a.abkjabatan_parent_id,a.abkjabatan_unit_id,COALESCE(d.jabatan_nama,e.jabatan_nama,i.jabatan_nama) AS jabatan_nama_parent,COALESCE(f.jabatan_nama,g.jabatan_nama,h.jabatan_nama) AS jabatan_nama,unit_nama,a.abkjabatan_level,a.abkjabatan_kebutuhan,a.abkjabatan_bezzeting,a.abkjabatan_sub_unit_id", FALSE);
        ...
        $this->datatables->add_column('action', '$1', 'abk_action(abkjabatan_id,abkjabatan_parent_id,abkjabatan_unit_id,abkjabatan_jabatan_id,abkjabatan_level,abkjabatan_kebutuhan,abkjabatan_bezzeting,abkjabatan_jenis_jabatan_id,abkjabatan_sub_unit_id)');
        return
    ...
    public function get_bezzeting($unit_id, $sub_unit_id, $jenis, $jabatan_id)
    {
        $this->db->select("*");
        ...
        $this->db->where('pegawai_jenisjabatan_kode', $jenis);
        	...
        	$this->db->where('pegawai_sub_unit_id', $sub_unit_id);
        }
    ...
    public function get_pegawai_by_jabatan($unit_id, $sub_unit_id, $jenis, $jabatan_id)
    {
    ...
    public function update_by_jabatan($jenis_lama,$jabatan_lama,$jenis_baru,$jabatan_baru,$unit_id_lama,$unit_id_baru,$sub_unit_id_lama,$sub_unit_id_baru)
    {
        $jenis = '1'; // update jabatan (ada penambahan & pengurangan )
         // die("CALL sp_proses_kgb('".$jenis."','".$jenis_lama."','".$jabatan_lama."','".$jenis_baru."','".$jabatan_baru."','".$unit_id_lama."','".$unit_id_baru."','".$sub_unit_id_lama."','".$sub_unit_id_baru."')");
        $sql = "CALL sp_update_peta_jabatan('".$jenis."',".$jenis_lama.",".$jabatan_lama.",".$jenis_baru.",".$jabatan_baru.",".$unit_id_lama.",".$unit_id_baru.",".$sub_unit_id_lama.",".$sub_unit_id_baru.")";
    ...
    public function update_by_mutasi_pensiun($jenis_lama,$jabatan_lama,$jenis_baru,$jabatan_baru,$unit_id_lama,$unit_id_baru,$sub_unit_id_lama,$sub_unit_id_baru)
    {
        $jenis = '2'; // update jabatan (ada penambahan & pengurangan )
         // die("CALL sp_proses_kgb('".$jenis."','".$jenis_lama."','".$jabatan_lama."','".$jenis_baru."','".$jabatan_baru."')");
        $sql = "CALL sp_update_peta_jabatan('".$jenis."',".$jenis_lama.",".$jabatan_lama.",".$jenis_baru.",".$jabatan_baru.",".$unit_id_lama.",".$unit_id_baru.",".$sub_unit_id_lama.",".$sub_unit_id_baru.")";
