...
SELECT 	 
	...
	FROM 
	pegawai WHERE pegawai_status = '1';";
        $this->db->query($query);
    }
    ...
    function update_rekap_agama() {
        $query = "CALL sp_rekap_agama()";
        return $this->db->query($query);
    }

    function update_rekap_eselon() {
        $query = "CALL sp_rekap_eselon()";
        return $this->db->query($query);
    }

    function update_rekap_golru() {
        $query = "CALL sp_rekap_golru()";
        return $this->db->query($query);
    }

    function update_rekap_jabatan() {
        $query = "CALL sp_rekap_jabatan()";
        return $this->db->query($query);
    }

    function update_rekap_jk() {
        $query = "CALL sp_rekap_jk()";
        return $this->db->query($query);
    }

    function update_rekap_pendidikan() {
        $query = "CALL sp_rekap_pendidikan()";
        return $this->db->query($query);
    }
