 ...
 * @author Zanuar
 */
class PendidikanJenisKelamin extends MY_Controller {
    ...
    function index() {
        ...
        $data['result'] = $this->m_pegawai_rekap->rekap_cpns_pendidikan($data['tahun'], $data['bulan'],2);
        $this->loadView('rekap/rekap_pendidikan_jenis_kelamin', $data);
    }
