                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-warning btn-sm" type="button" onclick="edit('<?= $value->berkas_id ?>','<?= $value->berkas_nama ?>','<?= $value->berkas_urut ?>','<?= $value->berkas_contoh ?>','<?= $value->berkas_jenis_mutasi_id ?>')" data-toggle="modal" data-target="#modal-update"><i class="fa fa-edit"></i></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_mutasi" class="form-control">
                            ...
                            <option value="1">Keluar Kabupaten / Kota</option>
                            <option value="2">Dalam Kota (Antar Intansi)</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
        ...
        <div class="modal-content">
            <form role="form" action="<?= site_url('referensi/BerkasMutasi/update') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Jenis Mutasi</label>
                        <select name="jenis_mutasi" id="edit_jenis_mutasi" class="form-control">
                            <option value="0">--Pilih Jenis Mutasi--</option>
                            <option value="1">Keluar Kabupaten / Kota</option>
                            <option value="2">Dalam Kota (Antar Intansi)</option>
                        </select>
...
<script>
    function edit(id, nama, urut, contoh, jenis_mutasi) {
        $('#edit_id').val(id);
        $('#edit_nama').val(nama);
        $('#edit_urut').val(urut);
        $('#edit_jenis_mutasi').val(jenis_mutasi).change();
        // console.log(contoh)
        if (contoh.length > 0) {
