...
$filter = $this->session->userdata('filterpangkat');
$newitem = $newitem_pangkat->new_item;
?>
          ...
          <div class="panel-body">
            ...
            <div class="box-footer">
              <div class="box-header with-border">
                ...
                <a href="<?= site_url('pangkat/PegawaiPangkat/add') ?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah</a>
              </div>
              <div class="box-body">
                <div class="row">
...
<script>
  ...
  $(document).ready(function() {
	...
	$('#notif').on('click', function() {
      swal({
        title: "",
        text: "Beri Tahu Atasan Untuk Menandatangani SK Pangkat?",
        type: 'info',
