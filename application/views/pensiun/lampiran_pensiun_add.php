...
1. Siapkan berkas Lampiran dalam bentuk file PDF<br>
2. Upload berkas lampiran maks 2MB<br>
</div>
                    </div>
                    <div class="box-body ">
                        <div class="row">
                ...
                <a href="<?= site_url('pensiun/LampiranPensiun') ?>" class="btn btn-primary pull-right">Kembali</a>
            </div>
        </div>
