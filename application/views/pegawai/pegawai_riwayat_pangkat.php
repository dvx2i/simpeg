...
<!--                                             <td><?= $value->pegawaipangkat_unit_kerja_nama ?></td> -->
                                            <td> <?php if(!empty($value->pangkatsk_file)) : ?>
                                                <a href="<?= base_url('assets/files/' . $value->pangkatsk_file) ?>" class="btn btn-success btn-sm"><i class="fa fa-file"></i> Unduh SK Pangkat</a>
                                                <?php endif; ?>
                                            </td>
                                            <td>
    	...
    	<div class="row" id="riwayat">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> SK Pangkat
                    </div>
                    <div class="panel-body">
                        <div class="box-body table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
...
<!--                                         <th>OPD/Unit Kerja</th> -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            <td><?= $value->pangkatsk_golongan ?></td>
                                            <td>tgl_indo($value->pangkatsk_tanggal_upload)</td>
                                            <td> 
                                                <a href="<?= base_url('assets/docs/pangkat/' . $value->pangkatsk_file) ?>" class="btn btn-success btn-sm"><i class="fa fa-file"></i> Unduh SK Pangkat</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
