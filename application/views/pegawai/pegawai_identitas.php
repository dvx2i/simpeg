...
<!--                                                     <option value="<?= $value->unit_id ?>" <?= selected($value->unit_id, $pegawai->pegawai_unit_id) ?>><?= $value->unit_nama ?></option> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email_instansi" value="<?= $pegawai->pegawai_email_instansi ?>" />
                                        </div>
                                        <div class="form-group">
...
<!--                                                     <option value="<?= $value->unit_id ?>" <?= selected($value->unit_id, $pegawai->pegawai_unit_id) ?>><?= $value->unit_nama ?></option> -->
                                        ...
                                        <div class="form-group">
                                            <label>Email Instansi</label>
                                            <input type="text" class="form-control" readonly value="<?= $pegawai->pegawai_email_instansi ?>" />
                                        </div>
                                        <div class="form-group">
