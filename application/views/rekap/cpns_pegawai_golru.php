...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            Rekap Jumlah CPNS Menurut Golongan Ruang
        </h1>
    </section>
        ...
        <div class="row" id="golru">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Jumlah CPNS Menurut Golongan Ruang <?= $unit != null ? $unit : ''; ?>
                    </div>
                    <div class="panel-body">
        ...
        <thead>
            <tr>
                <th colspan="6" rowspan="2"><b>
                        <center>Rekap CPNS Berdasarkan Gologan Ruang</center</b> </th> </tr> <tr>
            </tr>
            <tr>
                <th><b>No</b></th>
                <th><b>Unit</b></th>
...
<script>
    ...
    $('#excel-btn').click(function() {
        ...
        $("#example").table2excel({
            ...
            name: "Rekap_CPNS_Berdasarkan_Golongan",
            filename: "Rekap_CPNS_Berdasarkan_golru.xls", // do include extension
        ...
        $(function() {
            ...
            foreach ($rekap_golru->result_array() as $key) : ?>
                var barChart<?= $no++; ?> = {
                    ...
                    title: {
                        text: 'Jumlah CPNS Menurut Golongan Ruang ' + seriesName + '  <?= $unit != null ? $unit : ''; ?>'
                    },
                    subtitle: {
                        text: 'sipedas.sanggau.go.id</a>'
                    },
            ...
            colChart = {
                ...
                title: {
                    text: 'Jumlah CPNS Menurut Golongan Ruang  <?= $unit != null ? $unit : ''; ?>'
                },
                subtitle: {
                    text: 'sipedas.sanggau.go.id</a>'
                },
