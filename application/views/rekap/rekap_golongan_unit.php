...
<div class="content-wrapper">               
    ...
    <section class="content-header">
        ...
        <h1>
            Rekap PEGAWAI Unit Kerja Golongan Ruang
        </h1>
    </section>
        ...
        <div class="row" id="golru">
            <div class="col-lg-12">
                ...
                <div id="chart_golru" style="height: 600px;" width="100" ></div>
                    ...
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Rekap PEGAWAI Unit Kerja Golongan Ruang                        
                    </div>
                    <div class="panel-body" id="target_print">
                        ...
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td>
                                    <p align="center"><b>JUMLAH PEGAWAI DIRINCI MENURUT UNIT KERJA / JENIS KELAMIN DAN GOLONGAN RUANG
...
<script>
   ...
   //getting values of current time for generating the file name
        ...
        a.download = 'Reakap_PEGAWAI_Unit_Kerja_Golongan_Ruang_' + postfix + '.xls';
