...
class M_pegawai_pangkat extends MY_Model {
    ...
    function delete_berkas($id)
    {
       ...
       return $this->db->delete('pegawai_pangkat_berkas');
    }
    ...
    function json()
    {
      ...
      $this->datatables->select('pangkatsk_id,pangkatsk_nip,CONCAT(IFNULL(pegawai_gelar_depan,"")," ",pegawai_nama," ",IFNULL(pegawai_gelar_belakang,"")) as nama,pegawai_nama,CONCAT(pangkat_golongan_pangkat,"<br/> (",pegawai_pangkat_terakhir_golru,")") AS pangkat,pegawai_jabatan_nama,pegawai_unit_nama,pegawai_eselon_nama,pangkatsk_file,pangkatsk_status', FALSE);
      $this->datatables->from('pegawai_pangkat_berkas a');
      $this->datatables->join('pegawai b', 'a.pangkatsk_nip = b.pegawai_nip');
      $this->datatables->join('ref_pangkat_golongan c', 'b.pegawai_pangkat_terakhir_id = c.pangkat_golongan_id', 'LEFT');
      ...
      $this->datatables->add_column('sk', '$1', 'berkasPangkat(pangkatsk_file,pangkatsk_status)');
      $this->datatables->add_column('aksi', '$1', 'aksiPangkat(pangkatsk_id)');
    ...
    function insert_berkas($data) {
        $this->db->insert('pegawai_pangkat_berkas', $data);
        return $this->db->insert_id();
    }
}
