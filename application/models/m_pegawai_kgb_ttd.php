 ...
 * @author Zanuar
 */
class M_pegawai_kgb_ttd extends MY_Model{
    //put your code here
...
//     }
  ...
  function json()
  {
    ...
    $this->datatables->add_column('aksi', '$1', 'ttd_kgb(pegawaikgb_id,kgbsk_file)');
    $this->datatables->add_column('sk', '$1', 'sk_kgb(pegawaikgb_id,status_proses,kgbsk_file)');
